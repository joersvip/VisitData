...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const handleCreateRencana = (e: React.FormEvent) => {
    e.preventDefault();
                    ...
                    <tr key={r.id} className="hover:bg-slate-800/50 transition-all">
                      ...
                      <td className="p-3 text-right">
                        <button
                          ...
                          className="px-2.5 py-1 bg-slate-900 hover:bg-slate-800 text-amber-400 rounded text-[11px] font-bold border border-amber-500/30"
                        >
                          Lihat Peta
                        </button>
                      </td>
      ...
      {showAddRencanaModal && (
        <div className="fixed inset-0 bg-slate-950/85 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="glass-panel w-full max-w-xl p-6 space-y-4 animate-fade-in border-amber-500/40">
            <div className="flex items-center justify-between border-b border-amber-500/20 pb-3">
              <h3 className="text-base font-bold text-white flex items-center gap-2">
                <Calendar className="w-5 h-5 text-amber-400" /> Buat Rencana Kunjungan Lapangan Baru
              </h3>
              <button
            ...
            <form onSubmit={handleCreateRencana} className="space-y-3 text-xs">
